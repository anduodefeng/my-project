...
public class MyFundServiceImpl extends ServiceImpl<MyFundMapper, MyFund> implements MyFundService {
    ...
    public FundPageDTO getFundPage(FundPageVO fundPageVO) {
        ...
        IPage<MyFund> fundIPage = page(page, Wrappers.<MyFund>lambdaQuery().eq(MyFund::getType, fundPageVO.getType()).gt(MyFund::getFundMoney, 0).orderByDesc(MyFund::getProfitRate));
